  ...
  return (
    <main className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12">
      <section className="w-full max-w-lg rounded-md border border-rose-200 bg-white p-8 text-center shadow-sm">
        ...
        <h1 className="mt-2 text-2xl font-semibold text-slate-950">Anda tidak berhak mengakses halaman ini</h1>
        <p className="mt-3 text-sm leading-6 text-slate-600">
          Halaman Settings hanya dapat diakses oleh administrator dashboard.
        </p>
